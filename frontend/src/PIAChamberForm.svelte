<script>
  ...
  // pending: { lng, lat, chamber_id, chamber_seq, compass_dir, area_id, pop_id }
  ...
  let piaRef          = '';
  let openreachRef    = '';
  let piaChamberType  = 'STAKKABOX_FORTRESS';
  let lidType         = 'STEEL_CONCRETE';
  let depthM          = 0;
  let surfaceType     = '';
  let photoRef        = '';
  let notes           = '';
  ...
  function reset() {
    spurSuffix = ''; chamberSize = 'SMALL'; ringCount = 4;
    status = 'PROPOSED'; piaRef = ''; openreachRef = '';
    piaChamberType = 'STAKKABOX_FORTRESS'; lidType = 'STEEL_CONCRETE';
    depthM = 0; surfaceType = ''; photoRef = ''; notes = '';
  }
</script>
...
<div class="form">
  <div class="form-hdr">
    <span class="form-title">Place PIA UG Chamber</span>
  ...
  <div class="form-actions">
    ...
    <button class="btn-save" on:click={save}>Place PIA Chamber</button>
  </div>
</div>
{/if}

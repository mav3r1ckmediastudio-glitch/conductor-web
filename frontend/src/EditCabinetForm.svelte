...
<div class="form">
  ...
  <div class="form-body">
    ...
    <div class="field">
      <label for="a11y-editcabinetform-1">Site Name *</label>
      <input id="a11y-editcabinetform-1" bind:value={popName} placeholder="e.g. Tyndrum Cabinet 1" />
    </div>
    <div class="field">
      <label for="a11y-editcabinetform-2">POP Type</label>
      <select id="a11y-editcabinetform-2" bind:value={popType}>
    ...
    <div class="field">
      <label for="a11y-editcabinetform-3">Operator</label>
      <input id="a11y-editcabinetform-3" bind:value={operator} />
    </div>
    <div class="field">
      <label for="a11y-editcabinetform-4">Status</label>
      <select id="a11y-editcabinetform-4" bind:value={status}>
    ...
    <div class="field">
      <label for="a11y-editcabinetform-5">Address</label>
      <input id="a11y-editcabinetform-5" bind:value={address} placeholder="Street address (optional)" />
    </div>
    <div class="field">
      <label for="a11y-editcabinetform-6">Postcode</label>
      <input id="a11y-editcabinetform-6" bind:value={postcode} placeholder="e.g. FK20 8RU" maxlength="8" />
    </div>
    <div class="field">
      <label for="a11y-editcabinetform-7">Power Supply</label>
      <select id="a11y-editcabinetform-7" bind:value={powerSupply}>
    ...
    <div class="field">
      <label for="a11y-editcabinetform-8">Lease Expiry</label>
      <input id="a11y-editcabinetform-8" bind:value={leaseExpiry} placeholder="e.g. 2030-03-31 (optional)" />
    </div>
    ...
    <div class="field">
      <label for="a11y-editcabinetform-10">Photo Reference</label>
      <input id="a11y-editcabinetform-10" bind:value={photoRef} placeholder="Photo filename or URL (optional)" />
    </div>
    <div class="field">
      <label for="a11y-editcabinetform-9">Notes</label>
      <input id="a11y-editcabinetform-9" bind:value={notes} placeholder="Equipment orders, site access, survey findings…" />
    </div>

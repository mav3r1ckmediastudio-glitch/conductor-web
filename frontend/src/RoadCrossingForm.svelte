<script>
  ...
  function save() {
    dispatch('save', {
      ...
      duct_type:        ductType,
      installation_method: 'ROAD_CROSSING',
  ...
  function reset() {
    spurSuffix = ''; crossingType = 'OPEN_CUT'; ductType = 'HDPE_50_40';
    status = 'PROPOSED'; owner = 'Gigaloch'; roadName = '';
    permitRef = ''; permitExpiry = ''; piaRef = ''; openreachRef = '';
    wayleaveReq = false; wayleaveId = ''; notes = '';
  }
</script>
...
<div class="form">
  <div class="form-hdr">
    <span class="form-title">Road Crossing</span>
  ...
  <div class="form-body">
    ...
    <div class="check-row">
      ...
      <label for="rc-wl">Wayleave required</label>
    </div>
    {#if wayleaveReq}
    <div class="field">
    ...
    <div class="field">
      <input bind:value={notes} placeholder="Survey notes, traffic management, obstructions…" />
    </div>
